        ...
        <div className="wrapper">
          <div className="floating-box-one">
            <div className="inner-box-one">
              <div className="inner-text-box" role='complementary' aria-labelledby='winter-residents-title'>
                <p className="box-title" id='winter-residents-title'>
                  Winter Residents:
                </p>
                <div className="boxTitleUnderline" aria-hidden='true'></div>
                  <ul className="list">
