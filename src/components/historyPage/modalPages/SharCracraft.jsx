                ...
                <div className="cracraft__content-wrapper">
                    ...
                    <ul className="list">
                        <li className="list-item">
                            Wrote Social column for Riverside Daily Enterprise
                        </li>
                        <li className="list-item">
                            Writer for The Desert Sun and author
                        </li>
                        <li className="list-item">“Blue Book of the Desert”</li>
                        <li className="list-item">
                            Published “Personages” the “Who's Who” of the desert
                            1961 - 1982
                        </li>
                    </ul>
                    <div className="cracraft__quote">
                        <p>
                            “This house has spread its welcome mat to many
                            persons of note: Bing Crosby and Dixie, who rented
                            it one winter, and Maurice Chevalier, the French
                            charmer, did the same. Previous owner was Dan
                            Kimball, secretary of the Navy, and wife, Doris
                            Fleeson.”
                        </p>
                        <cite>- Cracraft</cite>
                    </div>
