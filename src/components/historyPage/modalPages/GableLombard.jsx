    ...
    return (
        <div className='gable-lombard'>
            <div className='img one'>
                <img  src={`https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1735422116/Hidden%20Gable%20Estate/history%20page/RoaringTwenties_ik20wu.jpg`} alt="" />
            ...
            <p>
            Gable and Lombard began a secret relationship that became public once his divorce from Langham was finalized in 1938.  Gable and Lombard (his true love) married soon after on March 12, 1939. 
            </p>
            ...
            <p>
            Their primary residence (purchased just before they married) was a 20-acre ranch in the city of Encino, less than 15 miles from the recording studios in Culver City.  However, they had a second home in Palm Springs (Hidden Gable Estate) until Carol Lombard's untimely death in 1942.  This was their most private desert hideaway.
            </p>
            <p>
            Shortly after Lombard's death, Gable, who was inconsolable and devastated by his loss, joined the United States Army Air Forces. Lombard had asked him to do that numerous times after the United States had entered World War II.  After officer training, Gable headed a six-man motion picture unit attached to a B-17 bomb group in England to film aerial gunners in combat, flying five missions himself.
            </p>
            <p>
            ...
            <p>
            In 1955, Clark Gable married Kay Spreckels.  Clark and Kay chose as their home a new development in the community of Bermuda Dunes, near Palm Springs, which abutted the private one-hundred-sixty-acre Bermuda Dunes Golf Club.
            </p>
        </div>
    )
}
