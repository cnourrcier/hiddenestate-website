...
const Douglas = () => {
    ...
    return (
        <section 
            className="douglas" 
            aria-labelledby='douglas-section-title'
        >
            <div className='douglas__flex-container'>
                <div className="douglas__video-container">
                    <video
                        controls
                        preload='metadata'
                        aria-label='Video of Joel Douglas discussing the Hidden Gable Estate'
                    >
                        <source 
                            src={ videoSrc } 
                            type="video/mp4" 
                ...
                <div className='douglas__content-container'>
                    ...
                    <div className='douglas__text-container'>
                        <div className='douglas__text-title'>
                            <h3 id='douglas-section-title'>Joel Douglas, Son of Kirk Douglas </h3>
                            <p><time dateTime='2014-11-02'>November 2, 2014 </time></p>
                        </div>
