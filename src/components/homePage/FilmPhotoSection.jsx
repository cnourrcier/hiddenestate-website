...
const FilmPhotoSection = () => {
    return (
        <section className="film-photo">
            <h2 className="film-photo__title">Film and Photo Opportunities</h2>
            ...
            <div className="film-photo__image-wrapper">
                <img
                    ...
                    alt="Historic weathervane and Spanish tile roof detail at Hidden Gable Estate"
                    className="film-photo__image"
                />
            </div>
            <div className="film-photo__links">
                <Link to="/rental/filmlocation" className="film-photo__link">
                    Film Location
                </Link>
