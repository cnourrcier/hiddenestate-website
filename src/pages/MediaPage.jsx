...
const MediaPage = () => {
    ...
    const mediaSpotlights = [
        {
            id: 1,
            headline:
                "Old Las Palmas Home Tour: A Peek Behind the Hedges lll, Celebrating Our First 100 Years",
            date: "February 17, 2025",
            type: "brochure",
            description:
                "Our property was featured in the prestigious Modernism 2025 Home Tour, showcasing its unique architectural design and contemporary aesthetics.",
    ...
    return (
        <main>
            <Helmet>
                <title>Hidden Estate Media Events</title>
            </Helmet>

            <div className="media-page">
                <div className="media__header-container">
                    <h1 className="media__header">
                        <span className="star">★</span> IN THE MEDIA{" "}
                        <span className="star">★</span>
                    </h1>
                    <p className="media__subheader">
                        Our historic Palm Springs property has been featured in
                        numerous publications and videos. Explore some of our
                        favorite media spotlights below.
                    </p>
                </div>
