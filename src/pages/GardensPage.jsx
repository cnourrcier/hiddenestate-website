...
const GardensPage = () => {
    ...
    const historicalGardenImages = [
            ...
            { id: 5, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736375711/Hidden%20Gable%20Estate/gardens%20page/cactus_workers_arizona_-_m_small_mu9i63.jpg`, text: `2nd Choice and by far the hardest to handle on account of the spreading branches. The top four feet broke off in transit.  It was about 21 feet high before it was broken and weight was over 2 tons. Patty & Agnes (Swobdi)`, alt: 'Cactus Motif'},
