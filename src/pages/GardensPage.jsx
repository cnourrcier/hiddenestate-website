...
const GardensPage = () => {
    ...
    const historicalGardenImages = [
            ...
            { id: 6, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736519290/Hidden%20Gable%20Estate/gardens%20page/Untitled-19_small_kz1far.jpg`, text: `Note Mrs Swodi's outfit and shoes while in a remote part of Arizona in the twenties.`, alt: 'Cactus Motif'},
            { id: 7, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736519290/Hidden%20Gable%20Estate/gardens%20page/Untitled-20_small_zwd0uj.jpg`, text: `We looked this one over but decided it was too large.`, alt: 'Cactus Motif'},
            { id: 8, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736519293/Hidden%20Gable%20Estate/gardens%20page/Untitled-21_small_ytgm4b.jpg`, text: `The twins shown in this picture next took our eye as being very attractive and we just had room for it on the trailer. While shifting the crate on the trailor. I fell into the plant and got plenty stuck up about it.`, alt: 'Cactus Motif'},
            { id: 9, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736519292/Hidden%20Gable%20Estate/gardens%20page/Untitled-32_small_gadddh.jpg`, text: `This shows the method of loading. We used sacks full of straw on the crate to protect the plants and plenty of brush between and over the large plants to enable us to put smaller ones on top. It took several Mexicans 2 days to cut enough brush. They worked slow.`, alt: 'Cactus Motif'},
            ...
            { id: 17, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `After being unloaded in Palm Springs`, alt: 'Cactus Motif'},
            { id: 18, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `The hoisting apparatus we used to plant them with.`, alt: 'Cactus Motif'},
        ...
        <div className='gardens'>
            ...
            <section className='gardens__middle-content'>
                ...
                <div className='gardens__showcase-images-container'>
                    ...
                    />
                    <img 
                        onClick={() => openModal({image: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736364893/Hidden%20Gable%20Estate/gardens%20page/Cactus_event_-_m_small_lgdphh.jpg`, modalTitle: 'Cactus Event'})}
