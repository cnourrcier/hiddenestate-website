...
const GardensPage = () => {
    ...
    const historicalGardenImages = [
            ...
            { id: 2, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `Our supply dump, in the hills near Quartsite Arizona. Lumber, straw, cases ropes, tools etc… All taken with us from Los Angeles. We had with us one 5-ton truck and trailer and two cars.`, alt: 'Cactus Motif'},
            ...
            { id: 10, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `Gunsight Mountain 25 miles S.E. of Ajo. This mountain is full of cacti of various sorts. The best of which is Lemaireocereus thurberi (Stenocereus thurberi). The arrow points to a Thurberi over 10 feet tall. Here we found the plant later named Echinocereus Meadii by Dr. H.D. Houghton.`, alt: 'Cactus Motif'},
            { id: 11, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `From near Tuscon Arizona`, alt: 'Cactus Motif'},
            { id: 12, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `At night from the nearest town, ship our days collection by freight to Los Angeles to be later FWD. to Palm Springs. These pictures show how we loaded our Packard each day.`, alt: 'Cactus Motif'},
            { id: 13, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `Loaded Packard`, alt: 'Cactus Motif'},
            { id: 14, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `Florence standing by Opuntia`, alt: 'Cactus Motif'},
            { id: 15, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `Carnegiea Gigantea Cristate - In the hospital grounds of the Indian Reservation. I believe the finest “crest” in the world. A perfect specimen.`, alt: 'Cactus Motif'},
            { id: 16, url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1736365526/Hidden%20Gable%20Estate/gardens%20page/cactus_motif_j99nbr.jpg`, text: `There are miles and miles of these Opuntias. They look like fruit trees loaded with fruit the year round.`, alt: 'Cactus Motif'},
