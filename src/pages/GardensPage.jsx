...
const GardensPage = () => {
    ...
    const historicalGardenImages = [
            ...
            { id: 5.1, url: `https://res.cloudinary.com/${imageUrl}/image/upload/v1736554119/Hidden%20Gable%20Estate/gardens%20page/cactus_workers_arizona_-_closeup_ochths.jpg`, text: `2nd Choice and by far the hardest to handle on account of the spreading branches. The top four feet broke off in transit.  It was about 21 feet high before it was broken and weight was over 2 tons. Patty & Agnes (Swobdi)`, alt: 'Cactus Motif'},
