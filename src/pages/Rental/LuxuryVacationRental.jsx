...
const LuxuryVacationRental = () => {
    ...
    const celebrityList = [
        ...
        {
            emoji: "🎱",
            name: "Kirk Douglas (who left behind his personal pool table!)",
        },
    ];
    ...
    const galleryImages = [
        {
            url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1734804922/Hidden%20Gable%20Estate/home%20page/5750_y8gi72.jpg`,
            alt: "Outdoor cabana seating area",
        },
        {
            url: `${import.meta.env.VITE_CLOUDFLARE_IMAGE_URL}/aceab53d-ed29-4aa3-49de-c11892d03400/public`,
            alt: "Pool and pickleball court with breathtaking views",
        },
        ...
        {
            url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1734719350/Hidden%20Gable%20Estate/home%20page/5742_mr4ibo.jpg`,
            alt: "Interior living space with fireplace",
        },
        {
            url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1734719452/Hidden%20Gable%20Estate/home%20page/5837_g7sld1.jpg`,
            alt: "Saltwater pool with Outdoor Kitchen",
        },
        {
            url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1740889953/Hidden%20Gable%20Estate/home%20page/5672_ueiwtz.jpg`,
            alt: "Kirk Douglas pool table",
        },
        {
            url: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_PRODUCT_ENV}/image/upload/v1741738121/Hidden%20Gable%20Estate/rental/20241122_151650_small_cqcacm.jpg`,
            alt: "Kirk Douglas pool table nameplate",
        },
    ];
            ...
            <div className="rental__content-container">
                <section className="rental__primary-section">
                    <div className="rental__header">
                        <h1>Luxury Vacation Rental at Hidden Estate</h1>
                        <h2>
                            <em>
                                Dramatic Mountain Views • Historic Celebrity
                                Estate
                            </em>
                        </h2>
                    ...
                    <div className="rental__details">
                        ...
                        <p>
                            Nestled in the prestigious Old Las Palmas
                            neighborhood, Hidden Estate is a historic Spanish
                            Colonial Revival estate offering a one-of-a-kind
                            luxury vacation rental experience in Palm Springs.
                            Rich in Hollywood lore and architectural charm, this
                            private 5-bedroom, 6-bathroom retreat accommodates
                            up to 10 guests, making it the ultimate desert
                            escape.
                        </p>
                        <p>
                    ...
                    <div className="rental__primary-content-wrapper">
                        ...
                        <div className="rental__list-container">
                            <h3>
                                A Storied Past – Hollywood's Desert Hideaway
                            </h3>
                            <p>
                                Designed by Master Architect McNeal Swasey for
                                famed fashion designer Swobdi in the 1920s,
                                Hidden Estate has been meticulously restored to
                                maintain its historic charm while offering
                                modern comforts. This estate has been a favorite
                                retreat for Hollywood's biggest icons,
                                including:
                            </p>
                            ...
                            <p>
                                The estate is featured on the Palm Springs
                                Historical Society Celebrity Homes Tour.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="rental__image-gallery-section">
                    <div className="rental__image-gallery" ref={galleryRef}>
                        {galleryImages.map((image, index) => (
                            <div
                                key={index}
                                className="rental__gallery-image-container"
                            >
                                <img
                                    src={image.url}
                                    alt={image.alt}
                                ...
                                <div className="rental__image-overlay">
                                    <span className="rental__image-caption">
                                        {image.alt}
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="rental__gallery-nav-button-container">
                        <button
                            className="rental__gallery-nav-button"
                ...
                <section className="rental__secondary-section">
                    <div className="rental__secondary-content-wrapper">
                        <div className="rental__list-container">
                            ...
                            <p>
                                Step outside to discover a private paradise
                                surrounded by towering palms, citrus trees, and
                                breathtaking desert views. Whether you're
                                looking for adventure or relaxation, the estate
                        ...
                        <div className="rental__list-container">
                            <h3 className="red">
                                Explore Palm Springs – Steps from the Best
                                Attractions
                            </h3>
                            <p>
                                Hidden Estate is located in Old Las Palmas,
                                often referred to as the "Beverly Hills of Palm
                                Springs", home to more celebrity residences than
                                any other neighborhood. Some of the stars who
                                have called this area home include Leonardo
                                DiCaprio, Goldie Hawn & Kurt Russell, Lily
                                Tomlin, Lucille Ball & Desi Arnaz, Elizabeth
                                Taylor, Liberace, Debbie Reynolds, Gene Autry,
                                and many more.
                            </p>
                            <p>
                ...
                <section className="rental__booking-section">
                    <div className="rental__list-container">
                        <h3 className="red">
                            Book Your Exclusive Stay at Hidden Estate
                        </h3>
                        <p>
                            Whether you're planning a{" "}
                            <strong>
                                family getaway, a retreat with friends, or a
                                romantic escape
                            </strong>
                            , this <strong>iconic Hollywood estate</strong> is
                            the ultimate destination for{" "}
                            <strong>luxury, privacy, and relaxation</strong>.
                        </p>
                        <button
                            onClick={handleClick}
